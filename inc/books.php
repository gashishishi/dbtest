...
// ヒアドキュメント
$booksList = <<<EOD
<div class="book-card row col-4 d-flex flex-column border border-1 justify-content-around">
<a class="" href="input-form.php?id={$id}">更新</a>

<img class="" src="{$id}.jpg">商品画像
